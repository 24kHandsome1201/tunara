cask "conduit" do
  ...
  homepage "https://github.com/24kHandsome1201/conduit"
  ...
  zap trash: [
    "~/Library/Application Support/dev.conduit.app",
    "~/Library/Preferences/dev.conduit.app.plist",
    "~/Library/Saved Application State/dev.conduit.app.savedState",
    "~/Library/Caches/dev.conduit.app",
  ]
end
