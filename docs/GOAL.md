...
当前主线没有自动进入的“下一阶段”。后续产品扩张必须先证明高频用户价值、明确数据与权限边界，并重新批准；现有回归重点是 PTY/SSH、Preview、safe-write、轻量 Agent Attention/resume，以及三套自动测试门。
