...
- SSH Claude 与 SSH Pi 的 resume，以及 provider 恢复后的本地/SSH OpenCode 与 SSH Aider resume；本地 Claude、本地 Codex、本地 Pi、SSH Codex 已用明确会话身份和上下文 token 通过。
