...
mod tests {
    ...
    fn readdir_attrs_are_only_consistency_hints() {
        ...
        assert_eq!(
            hinted_kind(Some(super::super::S_IFREG | 0o644)),
            Some(RemotePathKindV1::File)
        );
        assert_eq!(
            hinted_kind(Some(super::super::S_IFDIR | 0o755)),
        ...
        assert_ne!(
            hinted_kind(Some(super::super::S_IFREG)),
            Some(authoritative.kind)
        );
        assert_eq!(
            hinted_kind(Some(super::super::S_IFLNK)),
