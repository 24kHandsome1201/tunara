...
Tunara 是一个带智能侧栏的真实桌面终端。真实 xterm / PTY 是主角，侧栏按工作目录组织会话并展示运行状态和 Agent CLI 识别，右栏提供只读 Git diff 审查面板。它不是 Agent 管理平台、聊天工具、IDE 或 Git GUI。
...
前往 [Releases](https://github.com/24kHandsome1201/tunara/releases) 下载最新版本。
