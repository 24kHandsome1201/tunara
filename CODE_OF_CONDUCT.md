...
Tunara is a small open-source project and we want it to stay a place people enjoy contributing to.
...
- **Stay on topic.** Issues, PRs, and discussions are about Tunara. Take off-topic conversations elsewhere.
...
If you see a violation, contact the maintainers through the repository's public moderation channels or maintainer contact listed on GitHub. Include links and context.
