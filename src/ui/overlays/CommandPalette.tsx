...
function PaletteIcon({ icon }: { icon: typeof Terminal }) {
...
export function CommandPalette({ onClose }: { onClose: () => void }) {
  ...
  const commands = useMemo((): Command[] => {
    ...
    [...sessions]
      ...
      .forEach((s: Session) => {
        ...
        cmds.push({
          ...
          label: primary,
          subtitle,
          icon: s.pinned ? <PaletteIcon icon={PushPin} /> : <PaletteIcon icon={Terminal} />,
    ...
    cmds.push({
      ...
      icon: <PaletteIcon icon={FolderSimple} />,
      section: section.terminal,
      scopes: ["action", "terminal"],
      originalIndex: idx++,
      action: () => {
    ...
    cmds.push({
      ...
      icon: <PaletteIcon icon={HardDrives} />,
      section: section.ssh,
      scopes: ["action", "ssh"],
      originalIndex: idx++,
      action: () => {
    ...
    cmds.push({
      ...
      icon: <PaletteIcon icon={TerminalWindow} />,
      section: section.ssh,
      scopes: ["action", "ssh"],
      originalIndex: idx++,
      action: () => {
    ...
    cmds.push({
      ...
      icon: <PaletteIcon icon={BellSimple} />,
      section: section.session,
    ...
    if (activeSession) {
      cmds.push({
        ...
        icon: <PaletteIcon icon={CopySimple} />,
        section: section.terminal,
        scopes: ["action", "terminal"],
        originalIndex: idx++,
        action: () => {
      ...
      cmds.push({
        ...
        icon: <PaletteIcon icon={ClipboardText} />,
        section: section.terminal,
        scopes: ["action", "terminal"],
        originalIndex: idx++,
        action: () => {
      ...
      cmds.push({
        ...
        icon: <PaletteIcon icon={DownloadSimple} />,
        section: section.terminal,
        scopes: ["action", "terminal"],
        originalIndex: idx++,
        action: () => {
      ...
      if (activeIsLocal) {
        cmds.push({
          ...
          icon: <PaletteIcon icon={FolderSimplePlus} />,
          section: section.terminal,
          scopes: ["action", "terminal"],
          originalIndex: idx++,
          action: () => {
      ...
      if (activeIsLocal) {
        for (const entry of collectRecentTerminalCommands(recentCommands, activeSession.lastCommand)) {
          cmds.push({
            ...
            subtitle: activeSession.dir,
            icon: <PaletteIcon icon={Terminal} />,
            section: section.recent,
            scopes: ["action", "terminal", "recent"],
            originalIndex: idx++,
            action: () => {
      ...
      if (activeIsLocal) {
        cmds.push({
          ...
          subtitle: activeSession.dir,
          icon: <PaletteIcon icon={ArrowClockwise} />,
      ...
      cmds.push({
        ...
        icon: <PaletteIcon icon={AlignLeftSimple} />,
        section: section.files,
        scopes: ["action", "files"],
        originalIndex: idx++,
      ...
      cmds.push({
        ...
        icon: <PaletteIcon icon={AppWindow} />,
        section: section.files,
        scopes: ["action", "files"],
        originalIndex: idx++,
      ...
      if (activeSession.remote) {
        cmds.push({
          ...
          icon: <PaletteIcon icon={ArrowsDownUp} />,
          section: section.ssh,
          scopes: ["action", "ssh"],
          originalIndex: idx++,
        ...
        cmds.push({
          ...
          icon: <PaletteIcon icon={ShareNetwork} />,
          section: section.ssh,
          scopes: ["action", "ssh"],
          originalIndex: idx++,
      ...
      cmds.push({
        ...
        icon: <PaletteIcon icon={NotePencil} />,
        section: section.session,
        scopes: ["action", "session"],
        originalIndex: idx++,
        action: () => {
    ...
    cmds.push({
      ...
      icon: <PaletteIcon icon={SidebarSimple} />,
    ...
    cmds.push({
      ...
      icon: <Icon icon={SidebarSimple} size={14} mirrored />,
      section: section.layout,
      scopes: ["action", "layout"],
      originalIndex: idx++,
    ...
    cmds.push({
      ...
      icon: <PaletteIcon icon={SquareSplitHorizontal} />,
      section: section.layout,
      scopes: ["action", "layout"],
      originalIndex: idx++,
      action: () => {
    ...
    cmds.push({
      ...
      icon: <PaletteIcon icon={SquareSplitVertical} />,
      section: section.layout,
      scopes: ["action", "layout"],
      originalIndex: idx++,
      action: () => {
    ...
    cmds.push({
      ...
      icon: <PaletteIcon icon={ArrowLeft} />,
      section: section.layout,
      scopes: ["action", "layout"],
      originalIndex: idx++,
    ...
    cmds.push({
      ...
      icon: <PaletteIcon icon={ArrowRight} />,
      section: section.layout,
      scopes: ["action", "layout"],
      originalIndex: idx++,
    ...
    cmds.push({
      ...
      icon: <PaletteIcon icon={ArrowDown} />,
      section: section.layout,
      scopes: ["action", "layout"],
      originalIndex: idx++,
    ...
    cmds.push({
      ...
      icon: <PaletteIcon icon={ArrowCounterClockwise} />,
      section: section.app,
      scopes: ["action", "app"],
      originalIndex: idx++,
      action: () => {
