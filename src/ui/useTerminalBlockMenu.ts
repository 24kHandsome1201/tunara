...
export function useTerminalBlockMenu(
  ...
  const { blockAtPixel, copyBlockCommand, copyBlockOutput, copyBlockCommandAndOutput, revealBlock } = blocks;
  ...
  }, [blockAtPixel, copyBlockCommand, copyBlockOutput, copyBlockCommandAndOutput, revealBlock, sessionIdRef]);
}
